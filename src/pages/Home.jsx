  ...
  return (
    <>
      <section className='relative flex items-center justify-center text-center h-[90vh] overflow-hidden'>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/100 via-black/70 to-black/100"></div>
        <div className="relative z-10 w-2xl px-6 py-5 animate-fade-up">
          <span className=" px-3 py-1 mb-4 text-xs font-semibold tracking-wide text-yellow-500 uppercase bg-yellow-500/10 rounded-full border border-yellow-500/20">
              New Season Collection
            </span>
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-white mb-4 leading-tight italic uppercase tracking-tighter">
              Elevate <br/>
